...
def main(sim_id, pop_id, pop1, config_file, max_pop_id, path):
    input_file = f"{path}/{path}.hap.{sim_id}_0_{pop_id}.tped"
...
if __name__ == "__main__":
    if len(sys.argv) != 7:
        print("Usage: python extract_columns.py <sim_id> <pop_id> <pop1> <config_file> <max_pop_id> <path>")
        sys.exit(1)
    ...
    path = sys.argv[6]
    main(sim_id, pop_id, pop1, config_file, max_pop_id, path)
